...
void LoginDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onLoginClick(); break;
        case 2: _t->onRegisterClick(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LoginDialog::*)(const User & )>(_a, &LoginDialog::loginSuccess, 0))
            return;
    }
}
...
// SIGNAL 0
void LoginDialog::loginSuccess(const User & _t1)
{
