...
template <> constexpr inline auto AdminWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11AdminWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'loadAllUserList'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'freezeUserAccount'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'resetUserPwd'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'loadFoodStandard'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'addFoodStandard'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'editFoodStandard'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'deleteFoodStandard'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'backupWholeDB'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'restoreDBFile'
        QtMocHelpers::SlotData<void()>(10, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'showAllFeedback'
...
void AdminWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->loadAllUserList(); break;
        case 1: _t->freezeUserAccount(); break;
        case 2: _t->resetUserPwd(); break;
        case 3: _t->loadFoodStandard(); break;
        case 4: _t->addFoodStandard(); break;
        case 5: _t->editFoodStandard(); break;
        case 6: _t->deleteFoodStandard(); break;
        case 7: _t->backupWholeDB(); break;
        case 8: _t->restoreDBFile(); break;
        case 9: _t->showAllFeedback(); break;
        default: ;
        }
    }
    (void)_a;
